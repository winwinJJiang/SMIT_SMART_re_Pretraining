...
def swinv2_3D_SMIT_96_2_2_12_2_half(pretrained=False, **kwargs):
    model = SwinTransformerV2_MIM_SMIT_Half(
       img_size=128,window_size=4, embed_dim=96,patch_size=2, depths=(2,2,30,4), num_heads=(4,8,16,32),qkv_bias=True, **kwargs)
    #model.default_cfg = _cfg()
...
@register_model 
def swinv2_3D_tiny_window4_128(pretrained=False, **kwargs):
